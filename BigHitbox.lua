...
v8.CornerRadius = UDim.new(0 - 0, 10 + 0)
v9.Size = UDim2.new(791 - (368 + 423), 439 - 299, 18 - (10 + 8), 96 - 71)
v9.Position = UDim2.new(442 - (416 + 26), 31 - 21, 0 + 0, 96 - 41)
...
v10.CornerRadius = UDim.new(0 + 0, 782 - (201 + 571))
...
local function v53()
    ...
    while true do
        if (v54 == 0) then
            v52 = {}
            for v66, v67 in ipairs(v0:GetPlayers()) do
...
v7.FocusLost:Connect(
    function()
        local v55 = 0 + 0
        local v56
        while true do
            if (v55 == 0) then
                v56 = tonumber(v7.Text)
                if v56 then
                    _G.HeadSize = v56
                else
...
v11.MouseButton1Click:Connect(
    function()
        ...
        while true do
            if (v58 == (1 + 0)) then
                v60 = TweenInfo.new(0.5 + 0, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
                v61 = v3:Create(v5, v60, {Size = v59})
                v58 = 2
            end
            if (v58 == (887 - (261 + 624))) then
                v61:Play()
                v11.Text = (v13 and "▲") or "▼"
                break
            end
            if (v58 == (0 - 0)) then
                v13 = not v13
                v59 =
                    (v13 and UDim2.new(1080 - (1020 + 60), 160, 1423 - (630 + 793), 20)) or
                    UDim2.new(0 - 0, 757 - 597, 0, 44 + 66)
                v58 = 3 - 2
            end
        end
    end
)
v1.RenderStepped:Connect(
    function()
        if not _G.Disabled then
            for v64, v65 in ipairs(v52) do
                if (v65.Character and v65.Character:FindFirstChild("HumanoidRootPart")) then
                    local v69 = 1747 - (760 + 987)
                    local v70
                    while true do
                        if (v69 == (1914 - (1789 + 124))) then
                            --v70.Transparency = 0.9
                            v69 = 2
                        end
                        if ((1 + 1) == v69) then
                        ...
                        if (v69 == 0) then
                            v70 = v65.Character.HumanoidRootPart
